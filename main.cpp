...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Arham"<<endl;
        string phrase = "Good Morning Master Arham";
        ...
        cout<< "Good Afternoon Master Arham"<<endl;
        string phrase = "Good Afternoon Master Arham";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Arham"<<endl;
        string phrase = "Good Evening Master Arham";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER ARHAM|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER ARHAM";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="arham")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Arham...."<<endl<<endl;

                string phrase = "How can i help you Master Arham";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Arham....."<<endl;
                    string phrase = "Hello Master Arham";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Arham !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Arham !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
